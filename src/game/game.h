...
enum
{
    ...
    N_TAKEFLAG_HOLD, N_RETURNFLAG_HOLD, N_RESETFLAG_HOLD,  N_TRYDROPFLAG_HOLD, N_DROPFLAG_HOLD, N_SCOREFLAG_HOLD, N_INITFLAGS_HOLD,
...
static const int msgsizes[] =               // size inclusive message token, 0 for variable or not-checked sizes
{
    ...
    N_TAKEFLAG_HOLD, 3, N_RETURNFLAG_HOLD, 4, N_RESETFLAG_HOLD, 6, N_TRYDROPFLAG_HOLD, 1, N_DROPFLAG_HOLD, 7, N_SCOREFLAG_HOLD, 10, N_INITFLAGS_HOLD, 0,
